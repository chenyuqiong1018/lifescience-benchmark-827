...
SPEC = importlib.util.spec_from_file_location("checker_pocket", HERE / "scientific_checks.py")
...
class AcceptanceTests(unittest.TestCase):
    ...
    def test_wrong(self):
        result = CHECKER.check(self.workspace("wrong")); self.assertIn("DECISION_MISMATCH", result["failure_codes"]); self.assertLess(result["direction"], 15)
