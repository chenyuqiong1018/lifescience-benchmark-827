#!/usr/bin/env python3
"""Self-contained deterministic Oracle for ls05-structure-model-ranking."""
from __future__ import annotations
import base64

_EMBEDDED_FILES_B64 = {
    "gold.json": "",
}
...
if __name__ == "__main__":
    raise SystemExit(run("ls05-structure-model-ranking"))